          ...
          <>
            <Grid item xs={12} lg={6}>
              ...
              <Autocomplete
                ...
                renderInput={(params) => (
                  <TextField {...params} id={`text-field-1-${props.info._id}`} variant="standard" placeholder="+ Add" classes={{ root: classes.keywordInput }} />
                )}
            ...
            <Grid item xs={12} lg={6}>
              ...
              <Autocomplete
                ...
                renderInput={(params) => (
                  <TextField {...params} id={`text-field-2-${props.info._id}`} variant="standard" placeholder="+ Add more" classes={{ root: classes.keywordInput }} />
                )}
            ...
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField {...params} id={`text-field-1-${props.info._id}`} variant="standard" placeholder="+ Add more" classes={{ root: classes.keywordInput }} />
              )}
