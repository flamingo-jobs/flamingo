...
export default function DetailedAccordion(props) {
  ...
  const handleList = (list) => {
    setList(list);
    props.handleTechInputChange(props.techIndex, list, "list");
  };
  const handleFrontEnd = (list) => {
    setFrontEnd(list);
    props.handleTechInputChange(props.techIndex, frontEnd, "frontend");
  };
  const handleBackEnd = (list) => {
    setBackEnd(list);
    props.handleTechInputChange(props.techIndex, backEnd, "backend");
  };
