...
import { AreaSeries, Legend } from "@devexpress/dx-react-chart-material-ui";
...
const LineGraph = (props) => {
  ...
  const data = [
    getTotalApplications(day1full),
    getTotalApplications(day2full),
    getTotalApplications(day3full),
    getTotalApplications(day4full),
    getTotalApplications(day5full),
    getTotalApplications(day6full),
    getTotalApplications(day7full),
    getTotalApplications(day8full),
    getTotalApplications(day9full),
    getTotalApplications(day10full),
    getTotalApplications(day11full),
    getTotalApplications(day12full),
    getTotalApplications(day13full),
    getTotalApplications(day14full),
  ];
